package com.example.workmanage.security;
...
public class ApplicationConfig implements WebMvcConfigurer {
    ...
    public UserDetailsService userDetailsService(){
        return email -> (UserDetails) userRepo.findByEmail(email).orElseThrow(()-> new UsernameNotFoundException("Can not fine the user"));
    }
